        ...
        currentSolution.requiredLoops.forEach(loopType => {
            ...
            if (loopType === "ΓΙΑ") {
                ...
                if (forCount < 2) {
                    ...
                    feedback.push(
                        "Χρειάζονται δύο εμφωλευμένες επαναλήψεις ΓΙΑ για αυτό το πρόβλημα."
                    );
                ...
                if (whileCount < 2) {
                    ...
                    feedback.push(
                        "Χρειάζονται δύο εμφωλευμένες επαναλήψεις ΟΣΟ για αυτό το πρόβλημα."
                    );
                ...
                if (untilCount < 2) {
                    ...
                    feedback.push(
                        "Χρειάζονται δύο εμφωλευμένες επαναλήψεις ΜΕΧΡΙΣ_ΟΤΟΥ για αυτό το πρόβλημα."
                    );
